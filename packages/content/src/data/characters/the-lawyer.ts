...
const built = buildArt({
  bible: {
    ...
    weaponsProps: "a bulging leather briefcase, a gavel-headed cane and a rolled scroll of small print",
    ...
    signatureProps: ["a bulging briefcase", "a gavel-headed cane", "a rolled scroll of small print"],
  },
